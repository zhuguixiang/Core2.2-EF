...
namespace Core.EF.Application.Commom.Core
{
    class EFMapperTypeDescription
    {
        ...
        private List<EFMapperPropertyDescription> _propertyList = new List<EFMapperPropertyDescription>();
        public List<EFMapperPropertyDescription> PropertyList
        {
        ...
        public EFMapperTypeDescription(Type type)
        {
            Type = type;
            ...
            {
                EFMapperPropertyDescription propertyMappingDescription = new EFMapperPropertyDescription(property);
        ...
        {
            EFMapperPropertyDescription propertyMappingDescription = (EFMapperPropertyDescription)_propertyNames[propertyName];
    ...
    class EFMapperPropertyDescription
    {
        public string Name
        {
            get
        ...
        public EFMapperPropertyDescription(PropertyInfo property)
        {
